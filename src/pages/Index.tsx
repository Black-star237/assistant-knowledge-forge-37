          ...
          <main className="flex-1 overflow-auto bg-background mesh-bg">
            <div className="container mx-auto p-4 sm:p-6">
              ...
              <section className="mb-8">
                ...
                <div className="rounded-xl border border-border/40 p-6 glassmorphism bg-black/30">
                  ...
                  <div className="mt-6 space-y-4">
                    <div className="grid gap-2 grid-cols-2 sm:grid-cols-2 md:grid-cols-4 transparent-grid">
                      <div className="flex items-center gap-2 rounded-lg border border-border/30 p-4 bg-black/20 backdrop-blur-sm">
